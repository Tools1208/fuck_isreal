...
def display_banner():
    os.system('clear')
    # عرض الشعار باستخدام figlet من البيئة الافتراضية
    figlet_path = f"{sys.exec_prefix}/bin/figlet"
    banner = subprocess.getoutput(f"{figlet_path} Fuck_Isreal | lolcat 2>/dev/null || {figlet_path} Fuck_Isreal")
    print(banner)
...
class AdminFinder:
    def __init__(self, master):
        self.master = master
        self.master.title("Admin Finder v5.0")
